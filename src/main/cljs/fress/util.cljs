...
(defmethod byte-array ArrayList [^js al] (js/Int8Array. (.toArray al)))
...
(defmethod u8-array ArrayList [^js al] (js/Uint8Array. (.toArray al)))
...
(defmethod i32-array ArrayList [^js al] (js/Int32Array. (.toArray al)))
...
(defmethod f32-array ArrayList [^js al] (js/Float32Array. (.toArray al)))
...
(defmethod f64-array ArrayList [^js al] (js/Float64Array. (.toArray al)))
